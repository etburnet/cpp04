...
/*   Updated: 2025/03/25 09:21:42 by eburnet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << std::endl;
	std::cout << "-------------Demande sujet tableau-------------" << std::endl;
	size_t tab_size = 6;
	...
	std::cout << std::endl;
	std::cout << "-------------Constructeur de copie/operateu d'assignation-------------" << std::endl;
	Animal test;
	Cat chat;
	test = chat;
	Animal test1(test);
	...
	std::cout << std::endl;
	std::cout << "-------------Utilisation brain-------------" << std::endl;
	...
	std::cout << std::endl;
	std::cout << "-------------Duplication Brain-------------" << std::endl;
	Cat chat2(chat);
